...
| `setup` | Install and select the Margo agent, load chief-of-staff for matching tasks, and confirm the Work IQ connection works | Implemented | procedure | [Get a first useful brief](how-to/setup-and-migration.md#setup) |
